...
- 【S情報】：corrected_s_input への passthrough、A・P の判断材料（本人の訴えとして臨床判断に反映。例「痛みが増した」→ A で疼痛増悪評価、P でレスキュー検討）。O への発言の再掲はしない
...
2. 訪問メモ内にのみ出てくる本人・家族の発言は corrected_s_input に入れず、O に「本人より〜との訴えあり」「家族より〜との報告あり」と客観記載する
3. 【S情報】にある発言は O に再掲しない。「本人より〜との報告あり」等への言い換え・要約による転記も再掲にあたる。訪問メモ内に【S情報】と同内容の発言が出てくる場合も O には書かない（S欄が正。記録が二重に長くなるのを防ぐ）
